...
@section('content')
        ...
        <ul class="col-md-2">
            ...
            <li style="font-size:7px"><i class="fa fa-coffee" aria-hidden="true"></i> Как мы работаем <i class="fa fa-angle-right" aria-hidden="true" style="float: right"></i></li>
        </ul>
        <div class="col-md-10">
            <div >
                <h1>
...
1. Составьте свой заказ из продуктов, размещенных в каталоге сайта. <br>
2. В случае необходимости редактируйте свой заказ в корзине. <br>
3. Вы можете добавить комментарий к продукту.<br>
4. На странице «Информация для доставки» выберите адрес из списка сохраненных или добавьте новый. <br>
5. Введите имя и контактный номер телефона.<br>
6. Добавьте комментарий к заказу (при желании).<br>
7. Выберите наиболее удобный для Вас способ оплаты.<br>
8. После совершения заказа на Ваш мобильный телефон придет смс сообщение.<br>
9. Через несколько минут Ваш курьер свяжется с Вами для подтверждения заказа.<br>
            </div>
            <div>
                <div class="">
                    <h1>
